        ...
        <div class="row">
            <div class="confirm">
                ...
                <div class="col-xs-offset-5 col-xs-4">
                    ...
                    <a class="btn btn-default col-xs-offset-4 col-xs-5 center-block noborder btn-next" 
                    href="DetailHistory.php?id_order=<?php echo "#ใบสั่งซื้อ"+$_GET["id_order"];?>">ยืนยัน</a>
                </div>
            </div>
        </div>
    </div>